...
export default function SettingPlacesPage() {
    ...
    // const [message, setMessage] = useState({ type: 'success', text: 'Place information saved successfully.' });
    ...
    const handleAddPlace = id => {
        try {
            addPlace(id)
            setMessage({ type: 'success', text: 'Place information saved successfully.' });
            resetMessage()
        } catch (error) {
            console.error(error)
            setMessage({ type: 'error', text: 'Error saving place information.' });
            resetMessage()
        }
    }
